    ...
    <Page>
      <div className="row">
        ...
        <p>On September 12th to celebrate the release of Cardano smart contracts we will run a limited
           sale event for 100 <span style={{"color":"brown"}}>EARTH-LIKE</span> planets.  Participants will be able to try different seed phrases
           ...
           <span style={{"color":"#9600c7"}}>RARITY</span> attributes will be assigned at random during
            ...
            participation we will keep the $ERG price to no more than <span style={{color:"blue"}}>$10 USD</span>. Thank you for
